...
def draw_menue():
    ...
    if pos[1] > menue_rect.y - 10 or draw_menu_keyboard:
        ...
        draw_text(screen, "X", font_2, WHITE, menue_rect.right + 40, menue_rect.y + 7)
        draw_text(screen, f"{player.potion}", font1, WHITE, menue_rect.right + 55, menue_rect.y)
        ...
        draw_text(screen, "X", font_2, WHITE, menue_rect.right + 40, menue_rect.y + 37)
        draw_text(screen, f"{player.pokeball}", font1, WHITE, menue_rect.right + 55, menue_rect.y + 30)
    ...
    def PokemonInParty(self, x, y, lvl_100_states):
        ...
        if self.state_blit:
            ...
            if methode_lst[self.index_methode] == 2:
                ...
                for i, tm in enumerate(self.TM_LST):
                    ...
                    if tm.RemovedByUser:
                        ...
                        no_btn_del_tm, yes_btn_del_tm = draw_multyline_text(my_image, screen, pygame, warning_del_tm_text,
            ...
            if description_rect.collidepoint(pos):
                draw_multyline_text(my_image, screen, pygame, text, (535, 85), font0_0, BLACK, 200, 50, rect_pos=(0, 0))
            screen.blit(my_image, (0, 0))
...
class Trainer():
    ...
    def draw_menue(self):
        ...
        if self.warning2 and self.counter < 150:
            ...
            draw_multyline_text(my_image, screen, pygame, self.text_new_move, (x_pos + 100, 350), font, (60, 60, 60), 200, 250)
        ...
        if self.warning:
            ...
            answer_no_rect, answer_yes_rect = draw_multyline_text(my_image, screen, pygame, text_tm_del, (1.5 * x_pos, 1.5 * y_pos),
...
while run:
    ...
    if start_game == False:
        ...
        draw_text(screen, f'Game Level: {level}', font, set_color, 50,
    ...
    ##                    screen = pygame.display.set_mode((screen_width.value,screen_height.value))
            ...
            if no_enemy:
                ...
                draw_text(screen, 'Exit avilable.', font, WHITE, SCREEN_WIDTH // 2 - 100, 70)
